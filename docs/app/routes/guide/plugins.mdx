...
| **React** | Hand-picked | The `recommended` preset still ships `react-in-jsx-scope` — unnecessary since React 17. Hooks and JSX-A11y rules are selected individually for React 19+. |
