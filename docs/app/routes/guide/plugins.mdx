...
| [`eslint-plugin-simple-import-sort`](https://github.com/lydell/eslint-plugin-simple-import-sort) | Deterministic import/export ordering (auto-fixable) |
...
| [`@eslint/markdown`](https://github.com/eslint/markdown) | Lints code blocks inside Markdown files with your ESLint rules |
...
| [`eslint-plugin-react-compiler`](https://www.npmjs.com/package/eslint-plugin-react-compiler) | `react: true` | Validates compatibility with React Compiler's auto-memoization |
...
| [`eslint-plugin-testing-library`](https://github.com/testing-library/eslint-plugin-testing-library) | `*.test.{ts,tsx}` (with `react`) | Testing Library patterns — queries, async utilities, screen usage |
...
| [`eslint-plugin-storybook`](https://github.com/storybookjs/eslint-plugin-storybook) | `*.stories.{ts,tsx}` (with `react`) | Storybook CSF — story exports, play functions, hierarchy |
